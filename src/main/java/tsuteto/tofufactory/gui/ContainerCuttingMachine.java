...
public class ContainerCuttingMachine extends ContainerFactoryMachine
{
    public ContainerCuttingMachine(InventoryPlayer par1InventoryPlayer, TileEntityFactoryTfMachine par2TileEntityFurnace)
    {

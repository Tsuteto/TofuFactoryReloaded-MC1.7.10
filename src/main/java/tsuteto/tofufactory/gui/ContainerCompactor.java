...
public class ContainerCompactor extends ContainerFactoryMachine
{
    public ContainerCompactor(InventoryPlayer par1InventoryPlayer, TileEntityFactoryTfMachine par2TileEntityFurnace)
    {

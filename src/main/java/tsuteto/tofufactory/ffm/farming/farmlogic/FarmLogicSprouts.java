...
public class FarmLogicSprouts extends FarmLogicArboreal
{
    ...
    {
        super(housing, new ItemStack(Blocks.wool, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Blocks.wool, 1, OreDictionary.WILDCARD_VALUE),
                Farmables.farmables.get("farmSprouts"));
    }
